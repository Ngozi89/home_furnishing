...
class Order(models.Model):
    ...
    shiping_cost = models.DecimalField(max_digits=6, decimal_places=2, null=False, default=0)
...
class OrderLineItem(models.Model):
    ...
    def __str__(self):
        return f"ITEMNUMBER {self.product.itemnumber} on order {self.order.order_number}"